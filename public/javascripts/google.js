...
var drawNewsLetter = function(data) {
    ...
    drawLetter(first, data.openRates, _width, _height, margin);
    ...
    drawLetter(second, data.clickRates, _width, _height, margin)
    ...
    drawLetter(third, data.recipients, _width, _height, margin)
...
var drawSplashPage = function(data) {
    ...
    drawit(first, data['sessionsOverTime'], _width, _height, margin);
    ...
    drawit(second, data['pagesPerSession'], _width, _height, margin)
...
function drawit(svg, data, _width, _height, margin) {
    ...
    var xAxis = d3.svg.axis().scale(x)
        .orient("bottom").ticks(5).tickFormat(d3.time.format("%b"));
...
function drawLetter(svg, data, _width, _height, margin) {
